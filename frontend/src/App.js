...
import EmergencyContacts from './components/emergencyContact/index';
  ...
  return (
    <Router>
      ...
      <Routes>
        ...
        <Route exact path='/generateSOS' element={token ? <SOSPage /> : <Navigate to="/login" />} />
        <Route exact path='/addEmergencyContacts' element={token ? <EmergencyContacts /> : <Navigate to="/login" />} />
